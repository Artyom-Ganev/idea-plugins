...
public class DrlParameterListImpl extends ASTWrapperPsiElement implements DrlParameterList {

  public DrlParameterListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DrlParameter> getParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DrlParameter.class);
  }
