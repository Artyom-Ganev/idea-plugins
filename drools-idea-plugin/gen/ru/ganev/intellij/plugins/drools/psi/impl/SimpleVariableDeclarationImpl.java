...
public class SimpleVariableDeclarationImpl extends ASTWrapperPsiElement implements SimpleVariableDeclaration {
  ...
  public SimpleVariableDeclarationImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SimpleModifier getModifier() {
    return findNotNullChildByClass(SimpleModifier.class);
  }
  ...
  @Override
  @NotNull
  public List<SimpleVariableDeclarator> getVariableDeclaratorList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SimpleVariableDeclarator.class);
  }
