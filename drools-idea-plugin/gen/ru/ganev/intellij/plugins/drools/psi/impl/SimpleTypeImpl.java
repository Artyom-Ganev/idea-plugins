...
public class SimpleTypeImpl extends ASTWrapperPsiElement implements SimpleType {

  public SimpleTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  public SimpleTypeSpecifier getTypeSpecifier() {
    return findNotNullChildByClass(SimpleTypeSpecifier.class);
  }
