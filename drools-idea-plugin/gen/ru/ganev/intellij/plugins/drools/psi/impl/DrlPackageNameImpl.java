...
public class DrlPackageNameImpl extends ASTWrapperPsiElement implements DrlPackageName {

  public DrlPackageNameImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DrlPackageIdentifier> getPackageIdentifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DrlPackageIdentifier.class);
  }
