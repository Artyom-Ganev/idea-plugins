...
public class SimplePackageStatementImpl extends ASTWrapperPsiElement implements SimplePackageStatement {

  public SimplePackageStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public SimplePackageName getPackageName() {
    return findNotNullChildByClass(SimplePackageName.class);
  }
