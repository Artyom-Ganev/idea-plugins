...
public class DrlImportStatementImpl extends ASTWrapperPsiElement implements DrlImportStatement {

  public DrlImportStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  public DrlClassName getClassName() {
    return findChildByClass(DrlClassName.class);
  }

  @Override
  @Nullable
  public DrlPackageName getPackageName() {
    return findChildByClass(DrlPackageName.class);
  }
